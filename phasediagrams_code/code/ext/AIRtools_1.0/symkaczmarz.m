...
%
% Implements the symmetric Kaczmarz method: each sweep consists of a
% Kaczmarz sweep followed by a Kaczmarz sweep with the equations in
% reverse order.
%
% Input:
%   A          m times n matrix.
...
% Reference: Å. Bjorck and T. Elfving, Accelerated projection methods for 
